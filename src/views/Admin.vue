    ...
    <div class="admin-header">
      <div class="header-content">
        <div class="header-info">
          ...
          <p class="admin-subtitle">Manage users, referral codes, and system settings</p>
        </div>
      </div>
    </div>
      ...
      <div class="admin-section">
        <div class="section-header">
          ...
          <div class="section-info">
            ...
            <p class="section-subtitle">Configure OpenAI and Azure Speech services</p>
          </div>
        </div>
        ...
        <div class="section-content">
          ...
          <div class="settings-card">
            <div class="card-header">
              ...
              <div class="card-info">
                <h4 class="card-title">OpenAI Configuration</h4>
          ...
          <div class="settings-card">
            <div class="card-header">
              ...
              <div class="card-info">
                <h4 class="card-title">Azure Speech Service</h4>
      ...
      <div class="admin-section">
        <div class="section-header">
          ...
          <div class="section-info">
            ...
            <p class="section-subtitle">Manage users and referral codes</p>
          </div>
        </div>
